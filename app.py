...
Administrative = st.number_input('Enter Administrative value',step=1,format='%d')
Administrative_Duration = st.number_input('Enter Administrative_Duration value')
Informational = st.number_input('Enter Informational value',step=1,format='%d')
Informational_Duration = st.number_input('Enter Informational_Duration value')
ProductRelated = st.number_input('Enter ProductRelated value',step=1,format='%d')
...
OperatingSystems = st.number_input('Enter OperatingSystems value',step=1,format='%d')
Browser = st.number_input('Enter Browser value',step=1,format='%d')
Region = st.number_input('Enter Region value',step=1,format='%d')
TrafficType = st.number_input('Enter TrafficType value',step=1,format='%d')
Weekend = st.number_input('Weekend (0 = No, 1 = Yes)',step=1,format='%d')
